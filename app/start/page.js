        ...
        <main>
          <div className="flex flex-col">
            <nav className="w-full">
              ...
              >
                <div
                  ...
                  className="flex flex-col md:flex-row justify-between items-center p-4 max-w-screen-xl mx-auto gap-4"
                >
                  {/* Logo Section */}
                  <div data-testid="header-left" className="flex items-center">
                    <a
                      href="/"
                      className="flex items-center p-2 hover:bg-gray-100 rounded-md transition duration-300"
                    >
                      <svg
                  ...
                  {/* Phone Button */}
                  <button className="flex items-center bg-transparent p-0 focus:outline-none hover:opacity-90 transition duration-300">
                    <div className="flex items-center space-x-4">
                      ...
                      <h5 className="text-black text-base font-normal whitespace-nowrap">
            ...
            <div className="mt-8 mx-auto max-w-2xl">
              <h1 className="text-center text-[#2c2c2c] mb-8">
                <span className="text-3xl md:text-4xl lg:text-5xl font-normal block mb-2">
                  Hi, I'm Betsy!
                </span>
                <span className="text-2xl md:text-3xl lg:text-4xl font-normal text-[#2c2c2c]/90">
              ...
              <div className="flex flex-col gap-5">
                <button
                  ...
                  role="radio"
                  tabIndex="0"
                  className="flex items-center p-2 bg-white border border-green-600 rounded-md hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-300 ease-in-out"
                >
                  ...
                  <span className="text-[#292B29] font-medium">
                    Buying a home
                  </span>
                </button>
                ...
                >
                  <div className="flex items-center justify-center mr-2">
                    <svg
                      ...
                      width="36"
                      xmlns="http://www.w3.org/2000/svg"
                      className="transition duration-300 ease-in-out transform hover:scale-110" // Add hover effect
                    >
                ...
                <span class="css-8y1shf">Buying a home</span>
              </div>

              <div className="gap-5 flex flex-col md:flex-row justify-between p-4 bg-white shadow-lg rounded-lg">
                <div className="flex flex-col mb-4 md:mb-0">
                  <p className="text-2xl font-bold text-black css-dou93">
                    $100B
                  </p>
                  <p className="text-gray-600 css-1874ra6">
              ...
              <div className="mt-10 p-4 bg-green-100 rounded-lg shadow-md flex flex-col items-center ">
              <p className="text-lg font-semibold text-gray-800 css-yshr5u">
                After a few questions, you'll unlock:
              </p>
              <div className="mt-4 space-y-4 css-1d8k399">
                <div className="flex items-center">
                  <div className="flex-shrink-0 css-o0lktd">
                    <svg
                      fill="none"
                      height="22"
                      width="22"
                  ...
                  <div className="ml-2 css-1p4jfio">
                    <p className="text-gray-800 css-1ddb1th">
